...
const Sidebar = (props) => {
  ...
  return (
    <div id="mySidenav" className={`sidebar absolute pt-16 -right-96 top-0 min-h-screen bg-white shadow-xl divide-y divide-app-gray-100 flex flex-col  duration-500  ${tiny?"w-screen":"w-96"} ${open?"-translate-x-full":''} z-20`}>
